...
function Hk(a, b) {
  ...
  if (0 !== (d & 30) || 0 !== (d & a.expiredLanes) || b) b = Jk(a, d);
    ...
    K |= 2;
    var f2 = Kk();
    if (R !== a || Z !== b) (vk = null), (Hj = B$1() + 500), Lk(a, b);
    do
      try {
        Mk();
        break;
...
function Ui(a, b, c) {
  ...
  R === a &&
    (Z & c) === c &&
    (4 === T || (3 === T && (Z & 130023424) === Z && 500 > B$1() - gk)
      ? Lk(a, 0)
      : (sk |= c));
  Ek(a, b);
}
...
class RenderErrorBoundary extends react.exports.Component {
  ...
  render() {
    return this.state.error
      ? /* @__PURE__ */ jsx(RouteErrorContext.Provider, {
...
function RenderedRoute(_ref) {
  ...
  let dataStaticRouterContext = react.exports.useContext(
...
function _renderMatches(matches, parentMatches, dataRouterState) {
  ...
  if (errors != null) {
    let errorIndex = renderedMatches.findIndex(
      (m2) => m2.route.id && (errors == null ? void 0 : errors[m2.route.id])
    );
  ...
  return renderedMatches.reduceRight((outlet, match, index2) => {
    ...
    let errorElement = dataRouterState
      ? match.route.errorElement || /* @__PURE__ */ jsx(DefaultErrorElement, {})
      : null;
    let getChildren = () =>
      /* @__PURE__ */ jsx(RenderedRoute, {
        match,
        routeContext: {
          outlet,
    ...
    return dataRouterState && (match.route.errorElement || index2 === 0)
      ? /* @__PURE__ */ jsx(RenderErrorBoundary, {
