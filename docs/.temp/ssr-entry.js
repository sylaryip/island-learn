...
const Route0 = loadable(() => Promise.resolve().then(() => require("./assets/dep-aa78894f.js")));
const Route1 = loadable(() => Promise.resolve().then(() => require("./assets/a-a7c615da.js")));
const Route2 = loadable(() => Promise.resolve().then(() => require("./assets/b-cdf1d954.js")));
const Route3 = loadable(() => Promise.resolve().then(() => require("./assets/index-0d557886.js")));
const Route4 = loadable(() => Promise.resolve().then(() => require("./assets/index-ea5cff12.js")));
const routes = [
...
function render() {
  return server.renderToString(
    /* @__PURE__ */ jsxRuntime.jsx(StaticRouter, { location: "/", children: /* @__PURE__ */ jsxRuntime.jsx(App, {}) })
  );
}
